-- Tek tolerans: sadece late_join_minutes. minimum_remaining_minutes artık kullanılmaz.
...
begin
  ...
  if p_date = date(v_now_local) then
    ...
    -- Tek kural: start + late_join_minutes'e kadar alınabilir; bitiş uzamaz
...
grant execute on function public.book_reservation(uuid, date, int, int, text, text)
  to authenticated;
